...
<div class="profile-container">
    <div class="profile-header">
        <img src="{{ asset('uploads/faculty_photos/' . ($faculty->photo ?? 'default.png')) }}" alt="Profile Photo" class="profile-img">
    ...
    <form action="{{ route('faculty.update.password', $faculty->id) }}" method="POST">
        @csrf
        ...
        <div class="btn-container">
            ...
            <a href="{{ route('faculty.profile') }}" class="upload-btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
