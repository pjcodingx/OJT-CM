...
<div class="profile-container">
    <div class="profile-header">
        <img src="{{ asset('uploads/company_photos/' . ($company->photo ?? 'default.png')) }}" alt="Company Photo" class="profile-img">
    ...
    <form action="{{ route('company.update.password', $company->id) }}" method="POST">
        @csrf
        ...
        <div class="btn-container">
            ...
            <a href="{{ route('company.profile') }}" class="upload-btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
